        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Our mission is to provide businesses with the tools they need to effectively manage their Azure resources and optimize their resource usage. If you have any questions or feedback, please don't hesitate to reach out to our support team.</div>
            </div>
